...
parser.add_argument('--epochs', type=int, default=128, help='num of training epochs')
...
def main():
    ...
    scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, args.epochs, eta_min=0, last_epoch=63)
    start_epoch = 0
    best_top1_acc = 0
